...
<body>
    <main class="container">
        ...
        <form action="/emprestimos/deletar" method="post">
            <input type="hidden" name="id" value="<?= $id ?>">
            <div class="row">
                <div class="col-6">
                    <label for="data_emprestimo" class="form-label">Data de Empréstimo:</label>
                    <input disabled type="date" name="data_emprestimo" class="form-control" value="<?= $dataEmprestimo ?>">
                </div>
                <div class="col-6">
                    <label for="data_devolucao" class="form-label">Data de Devolução:</label>
                    <input disabled type="date" name="data_devolucao" class="form-control" value="<?= $dataDevolucao ?>">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                    <label for="id_livro" class="form-label">ID do Livro:</label>
                    <input disabled type="text" name="id_livro" class="form-control" value="<?= $idLivro ?>">
                </div>
                <div class="col-6">
                    <label for="id_cliente" class="form-label">ID do Cliente:</label>
                    <input disabled type="text" name="id_cliente" class="form-control" value="<?= $idCliente ?>">
                </div>
            </div>
            <div class="row mt-3">
                <div class="col">
